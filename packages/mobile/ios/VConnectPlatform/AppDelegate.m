...
//Augmentify View
- (void) openAugmentifyView: (NSURL *)experienceLink {
  dispatch_async(dispatch_get_main_queue(), ^{
    UIViewController *currentViewController = self.window.rootViewController;
    
    [AugmentifySDKManager.shared createAugmentifyViewControllerForUrl:experienceLink success:^(UIViewController *vc) {
